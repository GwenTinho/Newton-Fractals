...
function drawCanvas(imageData) {
    ...
    for (let y = 0; y < h; y++) {
        for (let x = 0; x < w; x++) {
            if (image[y][x].iteration !== -1) drawDot(x, y, image[y][x], colors.mapSmoothColour(), ctx); // rn theres mapColour and mapSmoothColor & mapcrazycolor idea of generating galeries
